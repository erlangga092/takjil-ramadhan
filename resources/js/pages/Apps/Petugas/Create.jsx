...
const Create = ({ masjids, rts, errors }) => {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    router.post("/apps/petugas", form, {
      onSuccess: () => {
        Swal.fire({
          title: "Success!",
          text: "Petugas saved successfully.",
          icon: "success",
  ...
  return (
    <>
      <Head>
        <title>Tambah Petugas - Takjil Ramadhan</title>
      </Head>
      <LayoutApp>
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="card border border-top-purple rounded-3 shadow">
                  <AppHeaderCard title="TAMBAH PETUGAS" icon="fa fa-folder" />
